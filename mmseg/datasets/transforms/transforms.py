...
class RandomCrop(BaseTransform):
    ...
    Args:
        ...
        centered (bool): Whether to perform centered cropping. Default: False
    """
    ...
    def crop_bbox(self, results: dict) -> tuple:
        ...
        if self.cat_max_ratio < 1.0 and not self.centered:
            # Repeat 10 times
            for _ in range(10):
    ...
    def __repr__(self):
        return (
            ...
            + f"(crop_size={self.crop_size}, centered={self.centered})"
        )
