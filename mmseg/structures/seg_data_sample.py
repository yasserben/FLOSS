...
class SegDataSample(BaseDataElement):
    ...
    @property
    def tube_tensor(self) -> PixelData:
        return self._tube_tensor

    @tube_tensor.setter
    def tube_tensor(self, value: PixelData) -> None:
        self.set_field(value, "_tube_tensor", dtype=PixelData)

    @tube_tensor.deleter
    def tube_tensor(self) -> None:
        del self._tube_tensor
